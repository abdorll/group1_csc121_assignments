...
//Function that prompts user to input first side
void input1(){
    triangleNo++;
    printf("TRIANGLE #%d\n", triangleNo);
...
//Function that prompts user to input second and third side
void input2And3(){
    printf("Enter side #2: ");
    scanf("%d", &b);
    printf("Enter side #3: ");
...
int main(void){
    ...
    while(a!=-1){ //while first sides is not equal to -1
        ...
        if( isRightAngleTriangle == 1){ //if isRightAngleTriangle is true
            printf("Triangle with sides %d, %d and %d MAKE a right-angled triangle.\n", a,b,c); //The 3 sides make a right-angled triangle
        }
        else{//if isRightAngleTriangle is false
            printf("Triangle with sides %d, %d and %d DOESN'T make a right-angled triangle.\n", a,b,c); //The 3 sides doesn't make a right-angled triangle
        }
        puts("");
